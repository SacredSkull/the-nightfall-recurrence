...
public static class AsyncTools
{
	...
	public abstract class Awaiter : INotifyCompletion
	{
		...
		public abstract void OnCompleted(System.Action action);
	...
	private class DelayAwaiter : Awaiter
	{
		...
		public override void OnCompleted(System.Action action)
		{
	...
	private class SynchronizationContextAwaiter : Awaiter
	{
		...
		public override void OnCompleted(System.Action action) => context.Post(state => action(), null);
	}

	private class ThreadPoolContextAwaiter : Awaiter
	{
		public override bool IsCompleted => IsMainThread() == false;
		public override void OnCompleted(System.Action action) => ThreadPool.QueueUserWorkItem(state => action(), null);
	}

	private class NextFrameAwaiter : Awaiter
	{
		public override bool IsCompleted => false;
		public override void OnCompleted(System.Action action) => NextFrameHelper.Enqueue(action);
	}
	...
	private class AsyncOperationAwaiter : Awaiter
	{
		...
		public override void OnCompleted(System.Action action) => asyncOp.completed += _ => action();
	}
	#endregion
}
#endif